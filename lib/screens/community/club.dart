...
class _CommunityClubScreenState extends State<CommunityClubScreen> {
  ...
  Widget _buildSendMessage(BuildContext context, ChatMessage message) {
    return Row(
  ...
  Widget _buildReceiveMessage(BuildContext context, ChatMessage message) {
    return Column(
      children: [
        SizedBox(height: 10),
        Row(
  ...
  Widget _buildMessageItem(BuildContext context, int index) {
    ...
    return message.type == 'in'
        ? _buildReceiveMessage(context, message)
        : _buildSendMessage(context, message);
  }
      ...
      child: Container(
        child: Column(
          ...
          children: [
            ...
            Container(
              height: getWindowHeight(context) - 480,
              color: white,
              child: ListView.separated(
                physics: BouncingScrollPhysics(),
                ...
                itemBuilder: (context, index) =>
                    _buildMessageItem(context, index),
              ),
            ),
            _buildMessageInput(),
          ],
